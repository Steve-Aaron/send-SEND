 ...
 * Renders the context and background information for the campaign.
 * Interacts with modal popups to explain complex educational consultation topics.
 */
export function InformationSection() {
    ...
    const stages = [
        {
            ...
            desc: 'The government reviews current provisions and identifies areas requiring input from children, young people, and their families.',
            fullDesc: 'During this initial stage, the Department for Education compiles data from local authorities, schools, and independent providers. The goal is to establish a baseline of current SEND provision quality and identify the most critical gaps in funding and support systems before proposing legislative changes.',
            img: 'https://placehold.co/600x400/00245D/FFFFFF?text=Information+Gathering+Stage'
        },
        {
            id: 'ii',
            title: 'Public Consultation',
            desc: 'A formal period where the public, professionals, and stakeholders submit their views on proposed systemic reforms.',
            fullDesc: 'This is the critical window where your voice matters most. The government publishes a Green Paper outlining their proposed changes to the SEND system. Parents, educators, and organizations have a set period (usually 12-14 weeks) to submit formal responses detailing how these changes will realistically impact vulnerable children.',
            img: 'https://placehold.co/600x400/D4A66E/FFFFFF?text=Public+Consultation+Stage'
        },
        {
            id: 'iii',
            title: 'Policy Formulation',
            desc: 'Responses are analyzed to inform final policy decisions and potential legislative changes to the SEND framework.',
    ...
    return (
        <div className="space-y-16 min-h-[200vh] pb-32">

            {/* About Section */}
            <section className="space-y-6">
                <h3 className="text-3xl font-serif font-bold text-brand border-b-2 border-accent pb-4 inline-block">Support SEND Education</h3>
                <div className="prose prose-slate max-w-none text-text-secondary space-y-4">
                    <p className="text-lg leading-relaxed font-medium">
                        The 2026 SEND consultation represents a critical juncture for vulnerable children across the nation. We must ensure that the government understands the real-world implications of their proposed reforms.
                    </p>
            ...
            {activeModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 pb-20 sm:pb-6">
                    <div className="absolute inset-0 bg-brand/80 backdrop-blur-sm transition-opacity" onClick={() => setActiveModal(null)}></div>
