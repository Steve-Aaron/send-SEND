  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 min-h-screen">
      ...
      <div className="prose prose-slate max-w-none text-text-secondary space-y-6">
        ...
        <p>
          We do not store the personal data you enter into the email generation
          form on our servers. The data (Name, Postcode, Address, Email, Phone
          Number) is processed purely in your browser to generate a template
          email which securely opens in your designated email client.
        </p>
        <p>
          We may collect anonymous usage data (such as page views and
          interaction metrics) to improve the performance and reach of the
          campaign.
        </p>
        ...
        <p>
          This website uses the UK Parliament API to retrieve public information
          regarding Members of Parliament. This website may include links to
