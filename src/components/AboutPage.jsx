  ...
  const steps = [
    {
      ...
      description:
        "The Government reviews how SEND support currently works and identifies areas where improvements may be needed. This stage helps highlight issues affecting children, young people and their families.",
    ...
    },
    {
      ...
      description:
        "Parents, professionals and members of the public are invited to share their experiences and views on proposed reforms to the SEND system by 18 May.",
      color: "text-slate-500",
    },
    {
      ...
      description:
        "The Government reviews consultation responses and other evidence before finalising policy decisions and any potential changes to SEND legislation.",
      color: "text-slate-500",
    },
  ];
    ...
    <div className="min-h-screen bg-bg-subtle flex flex-col items-center">
      <div className="w-full flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 bg-brand md:sticky md:top-0 md:h-screen flex items-center justify-center p-12 overflow-hidden relative min-h-[50vh] md:min-h-0">
          ...
          {/* Glowing orb effect aligned with SENDYourSay branding */}
          ...
          <motion.div
            ...
            className="relative z-10 w-48 h-48 md:w-64 md:h-64 border-2 border-white/10 bg-white/5 backdrop-blur-md rounded-3xl flex items-center justify-center p-8 shadow-2xl overflow-hidden"
          >
            <img
              src="/sys.png"
          ...
          <div className="max-w-xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-slate-600 leading-relaxed font-medium">
                We transform complex government processes into simple actions
                you can take in minutes. The current SEND consultation requires
                overwhelming public response to protect our children's future.
                Here's exactly how the process works and why your voice matters
                right now.
              </p>
            </motion.div>
            ...
            <div className="space-y-24">
              {steps.map((step, index) => (
                ...
                >
                  <h3
                    className={`text-xl md:text-2xl font-serif font-bold ${step.color} mb-2`}
                  >
                    {step.subtitle}
                  </h3>
