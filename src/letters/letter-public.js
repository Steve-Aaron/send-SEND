/**
 * Letter: Member of the Public
 * General constituent writing about SEND reform — no specialist personal context.
 */

const SUBJECT = 'SEND reforms – protecting children with the most complex needs';

export function getPublicLetter({ mpName, constituency, formData, postcode }) {
  const intro = `Dear ${mpName} MP,`;

  const body = `I am writing to you as a constituent who cares deeply about the future of children with special educational needs and disabilities.
